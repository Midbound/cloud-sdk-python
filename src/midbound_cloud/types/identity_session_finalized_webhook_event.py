...
class DataSessionEnrichment(BaseModel):
    enriched_at: float = FieldInfo(alias="enrichedAt")

    enrichment_data: str = FieldInfo(alias="enrichmentData")
...
class DataSession(BaseModel):
    ...
    last_activity: float = FieldInfo(alias="lastActivity")
    ...
    enrichments: Optional[List[DataSessionEnrichment]] = None
...
class Data(BaseModel):
    ...
    finalized_at: float = FieldInfo(alias="finalizedAt")

    session: DataSession

    session_ended_at: float = FieldInfo(alias="sessionEndedAt")
