...
class MidboundCloud(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        custom_headers_env = os.environ.get("MIDBOUND_CLOUD_CUSTOM_HEADERS")
    ...
    def with_raw_response(self) -> MidboundCloudWithRawResponse:
        return MidboundCloudWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> MidboundCloudWithStreamedResponse:
        return MidboundCloudWithStreamedResponse(self)
...
class AsyncMidboundCloud(AsyncAPIClient):
    ...
    def with_raw_response(self) -> AsyncMidboundCloudWithRawResponse:
        return AsyncMidboundCloudWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncMidboundCloudWithStreamedResponse:
        return AsyncMidboundCloudWithStreamedResponse(self)
...
class MidboundCloudWithRawResponse:
    _client: MidboundCloud

    def __init__(self, client: MidboundCloud) -> None:
        self._client = client
...
class AsyncMidboundCloudWithRawResponse:
    _client: AsyncMidboundCloud

    def __init__(self, client: AsyncMidboundCloud) -> None:
        self._client = client
...
class MidboundCloudWithStreamedResponse:
    _client: MidboundCloud
...
class AsyncMidboundCloudWithStreamedResponse:
    _client: AsyncMidboundCloud
...
AsyncClient = AsyncMidboundCloud
